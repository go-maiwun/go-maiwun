...
```mermaid
graph LR
    A[Agile Delivery Leadership<br/>PMP · PMI-ACP · Scrum] --> B[Cybersecurity<br/>Foundation]
    B --> C[Cloud Security<br/>AWS · Azure]
    C --> D[Applied Technical Depth<br/>for Secure, AI-Augmented Delivery]

    style A fill:#2E7D6E,stroke:#1B2027,color:#fff
    style B fill:#3E7C74,stroke:#1B2027,color:#fff
    style C fill:#46508C,stroke:#1B2027,color:#fff
    style D fill:#B4472B,stroke:#1B2027,color:#fff
```
